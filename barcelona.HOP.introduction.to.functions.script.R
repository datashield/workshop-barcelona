...
#CREATE DATAFRAME FOR OBESE ONLY
ds.propMean(opals,quote(D),outvar=quote(D$LAB_HDL),covar1=quote(D$PM_BMI_CATEGORIAL))

datashield.assign(opals,"OB",quote(PM_BMI_CATEGORIAL$PM_BMI_CATEGORIAL.level_3))

ds.names(opals,quote(OB))

glm9 <- ds.glm(datasources=opals, formula=OB$HLTH_OBESE_STRICT ~ OB$GENDER+OB$AGE_YRS, family=quote(binomial), maxit=quote(20))
glm9

datashield.assign(opals,"age.o.c",quote(OB$AGE_YRS-50))
datashield.assign(opals,"age.o.c.2",quote(age.o.c^2))

ds.contourplot(opals,quote(age.o.c),quote(age.o.c.2),type="split")

glm10 <- ds.glm(datasources=opals, formula=OB$HLTH_OBESE_STRICT ~ OB$GENDER*age.o.50+age.o.50.2, family=quote(binomial), maxit=quote(20))
glm10

glm11 <- ds.glm(datasources=opals, formula=OB$HLTH_OBESE_STRICT ~ OB$GENDER*age.o.50, family=quote(binomial), maxit=quote(20))
glm11

glm12 <- ds.glm(datasources=opals, formula=OB$HLTH_OBESE_MODERATE ~ OB$GENDER*age.o.50+age.o.50.2, family=quote(binomial), maxit=quote(20))
glm12

ds.table2d(opals,quote(age.o.c),quote(age.o.c.2),type="split")
